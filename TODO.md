...
- Определять тип файлов по содержимому, а не по расширению:
    - magic - пайтон библа для определния mime-type по содержимому
    - flask - content-type у полученных файлов

- Файлы кода не анализировать отдельно, а брать их содержимое в расчет при анализе документа
